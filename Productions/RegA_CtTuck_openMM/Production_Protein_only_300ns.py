#Hey there! It's Grace, I have edited this script from the 'making it rain' protein colab page to be generalizable. As long as it is being run a folder with a workdir folder containing equilibrium pdb and rst scripts called (be sure to change the names below), this will run just fine! It will be for 300ns, 1 stride, but this can be adjusted as needed. 
...
Equilibrated_PDB = 'RegA_noCorN_equil.pdb' #@param {type:"string"}
State_file = 'RegA_noCorN_equil.rst' #@param {type:"string"}
